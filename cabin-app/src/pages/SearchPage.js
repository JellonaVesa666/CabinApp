    ...
    <div className="row h-100 m-0 p-0">
      ...
      <div className="row justify-content-center m-0 p-0" style={{ height: "70%", backgroundColor: "rgba(255, 255, 255, 0.3)" }}>
        <div className="col-8 d-flex flex-wrap" >
          <div className="col d-flex justify-content-end align-items-center col-lg-6 px-4" style={{ height: "50%" }}>
            <div className="d-flex justify-content-center align-items-center" style={{ height: "85%", width: "75%", border: "2px solid black" }}>
              dada
            </div>
          </div>
          <div className="col d-flex justify-content-start align-items-center col-lg-6 px-4" style={{ height: "50%" }}>
            <div className="d-flex justify-content-center align-items-center" style={{ height: "85%", width: "75%", border: "2px solid black" }}>
              dada
            </div>
          </div>
