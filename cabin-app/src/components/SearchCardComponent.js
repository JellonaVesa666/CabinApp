...
const SearchCardComponent = () => {
  ...
  return (
    <SearchCardBody>
      <div style={{ height: "20%", borderTop: "2px solid rgba(0, 0, 0, 0.06)", borderBottom: "2px solid rgba(0, 0, 0, 0.06)" }}>
        ...
        <div class="row justify-content-center m-0 p-0" style={{ height: "50%" }}>
          <div class="col-9 d-flex justify-content-center align-items-center mt-5 p-0" >
        ...
        <div class="row justify-content-center m-0 p-0" style={{ height: "50%", position: "relative" }}>
          <div class="col-9 d-flex justify-content-center align-items-center m-0 p-0" >
            <input value="SEARCH" className="text-center p-2" style={{ borderRadius: "8px", color: "white", outline: "0", backgroundColor: "rgba(0, 0, 0, 0.7)", width: "20%" }} type="button" />
          </div>
